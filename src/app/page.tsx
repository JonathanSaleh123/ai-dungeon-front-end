              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="createName"
                    className="w-full px-4 py-2 rounded bg-gray-600 border border-gray-500 text-white focus:outline-none focus:border-purple-500"
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="joinName"
                    className="w-full px-4 py-2 rounded bg-gray-600 border border-gray-500 text-white focus:outline-none focus:border-pink-500"
                    placeholder="Enter your name"
                  />
                </div>
                <div>
